...
img_paths = {
    'E01': 'teamproject/test/data/E01/C8.jpg',
    'E02': 'teamproject/simple_face_recognition-master/img/trinity.jpg'
}
...
np.save('teamproject/simple_face_recognition-master/img/TEST1.npy', descs)
print(descs)


img_bgr = cv2.imread('teamproject/test/data/E01/C9.jpg.jpg')
img_rgb = cv2.cvtColor(img_bgr, cv2.COLOR_BGR2RGB)
...
plt.axis('off')
plt.savefig('teamproject/test/TEST_output.png')
plt.show()