...
print('test_x.shape: ', data_gen[0][0].shape) # (200, 150, 150, 3)
print('test_y.shape: ', data_gen[0][1].shape) # (200,)
test_x = data_gen[0][0]
test_y = data_gen[0][1]

import numpy as np
np.save('./teacher/cslee2', arr=data_gen[0][0])
np.save('./teacher/cslee2', arr=data_gen[0][1])
