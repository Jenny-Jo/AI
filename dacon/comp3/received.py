...
X_data = np.loadtxt('F:\\Study\\data\\dacon\\comp3\\train_features.csv',skiprows=1,delimiter=',')
X_data = X_data[:,1:]
print(X_data.shape)
     
    
Y_data = np.loadtxt('F:\\Study\\data\\dacon\\comp3\\train_target.csv',skiprows=1,delimiter=',')
Y_data = Y_data[:,1:]
print(Y_data.shape)
...
X_data_test = np.loadtxt('F:\\Study\\data\\dacon\\comp3\\test_features.csv',skiprows=1,delimiter=',')
