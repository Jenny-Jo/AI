...
input1 = Input(shape=(3, )) #변수명은 소문자/함수형은 input이 뭔지 명시해줌

dense1 = Dense(5, activation='relu')(input1) #제일 앞의 것이 출력값/활성화 함수/맨 뒤에 앞단의 아웃풋이 input으로 지정
dense1 = Dense(100, activation='relu')(dense1) #활성화함수 안써도 되는 이유; 디폴트가 있음
dense1 = Dense(100, activation='relu')(dense1) #활성화함수 안써도 되는 이유; 디폴트가 있음
dense1 = Dense(100, activation='relu')(dense1) #활성화함수 안써도 되는 이유; 디폴트가 있음
dense1 = Dense(100, activation='relu')(dense1) #활성화함수 안써도 되는 이유; 디폴트가 있음
dense1 = Dense(100, activation='relu')(dense1) #활성화함수 안써도 되는 이유; 디폴트가 있음
