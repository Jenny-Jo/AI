...
model = GridSearchCV(XGBClassifier(), parameters, cv=5, n_jobs=-1) # n_jobs 는 속도 높이기 위해 그리드 서치에 통으로 돌린다
...
-------------------------------------
{'colsample_bylevel': 0.9, 'colsample_bytree': 1, 'learning_rate': 0.5, 'max_depth': 6, 'n_estimators': 90}
-------------------------------------
