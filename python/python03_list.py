...
a = [1,2,3]
b = [4,5,6]
print( a + b )                          # [1, 2, 3, 4, 5, 6] 리스트뒤에 리스트 붙임/ numpy로는 [5,7,9]로 나옴
c = [7,8,9,10]                          
...
#################################################################
# a = a.append(5)                       # print(a) #문법 에러/ None
...
print(a.index(3))                       #색인 / ==a[3] # 1
print(a.index(1))                       # ==a[1] 

a.insert(0, 7)                         
print(a)                                #0번째 인덱스를 7으로 하여, [7,4,3,2,1]이 됨
