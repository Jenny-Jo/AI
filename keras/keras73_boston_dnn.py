...
modelpath = './model/sample/boston/{epoch:02d}-{val_loss:.4f}_checkpoint_best.hdf5'
...
model.save('./model/sample/boston/boston_model.save.h5')
model.save_weights('./model/sample/boston/boston_save_weight.h5')
