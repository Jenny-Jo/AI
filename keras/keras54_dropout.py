...
model.add(Conv2D(50, (2,2), input_shape = (28,28, 1), strides = (2,2), padding='same', activation = 'relu'))
model.add(Conv2D(50,(3,3)))
model.add(Conv2D(50, (2,2)))

model.add(MaxPooling2D(pool_size=4))
model.add(Dropout(0.3)) ##아무데나 써도 됨 20프로 제거



model.add(Flatten()) 
model.add(Dense(10, activation = 'softmax')) ## 다중분류에서 softmax는 맨 끝 레이어에만!
...
model.fit(x_train, y_train, epochs = 20, batch_size= 256, verbose=1, callbacks= [early_stopping], validation_split = 0.2)
