...
# input1 = Dense (30)(input1)
# input1 = Dense (30)(input1)
# ValueError: Graph disconnected: cannot obtain value for tensor Tensor("input_1:0", shape=(None, 3, 1), dtype=float32) at layer "input_1". The following previous layers were accessed without issue: []
# PS F:\Study>
