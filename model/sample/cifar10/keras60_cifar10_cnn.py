...
verbose= 1, callbacks = [early_stopping,checkpoint], validation_split= 0.2)

model.save('./model/sample/cifar10/cifar10_01.h5')
model.save_weights('./model/sample/cifar10/cifar10_weight1.h5')
