...
model.fit(x_train, y_train, epochs = 10, batch_size= 256, verbose=0, callbacks= [early_stopping, checkpoint], validation_split = 0.2)
model.save_weights('./model/sample/mnist/mnist_weight.h5')
model.save('./model/sample/mnist/mnist2_model.save.h5')
